...
```
vietnamtravel <command> [arguments] [flags]
```

Run `vietnamtravel <command> --help` for the full flag list on any command. This
...
per operation you declare in `vietnamtravel/domain.go`.
